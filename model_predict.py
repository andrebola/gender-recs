...
if __name__== "__main__":
    ...
    item_ids, item_vecs_reg, user_ids, user_vecs_reg = train_als(fan_train_data, 300, fan_users_dict, fan_items_dict, user_features_file, item_features_file, save_res=True)
